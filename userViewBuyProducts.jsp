...
<div class="newsletter">
		...
		<div class="row">
				<div class="col-md-12">
					<div align="center">
						<h2 style="color: blue">View Buy Products Details</h2>
						<br />
					</div>
				</div>
			</div>
			<%
				...
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM `cart_buy_products` WHERE `u_id`='"+ email + "' AND `p_status`='Buy' ORDER BY id DESC");
