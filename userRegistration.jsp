...
<body>
	...
	<div class="newsletter">
		...
		<br />
		<form action="UserRegistration" method="POST" id="contact_form" name="ureg">
			<table id="simple-table" style="width: 60%"
				class="table  table-bordered table-hover">
				<tr>
					<th>FirstName:</th>
					<td><input type="text"  onblur="return AllowAlphabet()" placeholder="FirstName" name="fname" required></td>
				</tr>
				<tr>
					<th>LastName:</th>
					<td><input type="text"  onblur="return AllowAlphabet()" placeholder="LastName" name="lname" required></td>
				</tr>
				...
				<tr>
					<th>AdharCard No:</th>
					<td><input type="text" placeholder="Enter adharno."  onblur="return ValidateUID()" name="adharno"></td>
				</tr>
				...
				<tr>
					<td></td>
   					<td>Already have an account<button class="btn btn-link" type="button"><a href="userLogin.jsp">Login</a></button> </td>
    			</tr>
			</table>
		</form>
	</div>
