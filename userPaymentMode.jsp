	...
	<div class="newsletter">
		<div class="container">
			<div class="row">
				<div class="col">
					<div align="center">
						<h2 style="color: blue">Final Order Summery</h2>
						<br />
					</div>
				</div>
			</div>
					...
					<table class="table table-bordered">
						<tbody>
							<tr>
								...
								<td><%=session.getAttribute("product_count").toString() %></td>
							</tr>
							<tr>
								<td>Total Payments</td>
								<td><%=session.getAttribute("total_cost").toString() %></td>
							</tr>
							<tr>
								<td>Product Delivery Option</td>
								<td><input type="radio" value="getDelivery" required="required" name="d_option">&nbsp;&nbsp;Register Address</td>
							</tr>
							<tr>
								<td></td>
								<td><input type="radio" value="pick_up" required="required" name="d_option">&nbsp;&nbsp;Pick
									from Shop</td>
							</tr>
							<tr>
