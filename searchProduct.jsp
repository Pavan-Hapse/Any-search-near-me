	...
	<div class="newsletter">
		<div class="container">
			<div class="row">
				<div class="col">
					<div align="center">
					<h2 style="color: blue">Search Product</h2>
					<br/>	
					<form  action="viewproductDetails.jsp" method="POST" id="contact_form">	
					<table id="simple-table" style="width: 60%"
								class="table  table-bordered table-hover">
								<tr>
									<td><input type="text" placeholder="Search Here or Enter..." name="search" style="width: 520px; height: 40px;" required></td>
									<td><input type="submit" value="Search" style="width: 120px;height: 40px;"></td>
								</tr>
						</table>
