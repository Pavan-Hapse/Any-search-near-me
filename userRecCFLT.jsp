...
<%@page import="com.code.CollaborativeFilteringML"%>
...
<body>
	...
	<div class="newsletter">
		...
		<div class="row">
			...
			<h2 style="color: blue;">Products Recommendation Based on Collaborative Filtering</h2>
			<br/>	
			<% 
				...
				CollaborativeFilteringML clf=new CollaborativeFilteringML();
				HashSet<String> pp_id=clf.getProductBasedOnC_FLTR(request);
				System.out.print("pp "+pp_id);
				for(String ppid:pp_id)
				{
				
				Connection conn = DbConnection.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM `product` where p_id='"+ppid+"'");
