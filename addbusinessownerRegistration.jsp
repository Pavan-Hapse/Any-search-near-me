...
<body>
	...
	<div class="newsletter">
		...
		<br/>
		<form action="BusinessOwnerReg" method="POST" id="contact_form" enctype="multipart/form-data" >
			<table id="simple-table" style="width: 60%"
				...
				<tr>
					...
					<td><input type="text"  placeholder="Enter FirstName" name="fname" required></td>
				</tr>
				<tr>
					<th>Business Owner LastName:</th>
					<td><input type="text"  placeholder="Enter LastName" name="lname" required></td>
				</tr>
				<tr>
					<th>Mobile No.:</th>
					<td><input type="text"  placeholder="Enter Only 10 Digit" name="mobileno" required></td>
				</tr>
				<tr>
				<tr>
					<th>AdharCard No.:</th>
					<td><input type="text"  placeholder="Enter adharno." name="adharno" required></td>
				</tr>
				<tr>
				<tr>
					<th>Email Id:</th>
				...
				<tr>
					<td></td>
					<td><input type="submit" value="Registration">&nbsp&nbsp&nbsp&nbsp<input type="reset" value="Reset"></td>
				</tr>
			</table>
		</form>
	</div>
